...
//rom struct{byte bLength;byte bDscType;word string[14];}PrdString={
//sizeof(PrdString),DSC_STR,
//'T','r','i','p','p',' ','L','i','t','e',' ','U','P','S'};

//rom struct{byte bLength;byte bDscType;word string[14];}SerialString={
//sizeof(SerialString),DSC_STR,
//'B','O','O','T'};

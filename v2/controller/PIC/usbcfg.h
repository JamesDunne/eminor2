...
//#define UCFG_VAL                _TRINT|_LS|MODE_PP		//(Tripp board)
...
//HID Out endpoint size cannot be bigger than 64
//HID In endpoint size cannot be bigger than 64
/* HID */
...
#define HID_RPT_UPS_SIZE		124				//was 112

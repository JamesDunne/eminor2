...
java -jar compiler.jar --js es5.js web.js typedarray.js storage.js console.js rainbow.js c.js generic.js eminorv2.gen.js driver.js --js_output_file www/all.min.js
#mv eminorv2.js.mem ..

...
var Module;
if (!Module) Module = eval('(function() { try { return eminorv2 || {} } catch(e) { return {} } })()');
...
/* memory initializer */ allocate([84,85,86,87,88,89,0,0], "i8", ALLOC_NONE, Runtime.GLOBAL_BASE)
...
Module["_controller_10msec_timer"] = _controller_10msec_timer;
function _button_pressed($mask) {
 var label = 0;
 label = 1; 
 while(1) switch(label) {
  case 1: 
   ...
   var $8=(($7)&(65535));
   var $9=(($6)|(0))==(($8)|(0));
   if ($9) { label = 2; break; } else { var $18 = 0;label = 3; break; }
  case 2: 
   var $11=HEAP16[((24)>>1)];
   var $12=(($11)&(65535));
   var $13=$1;
...
Module["_controller_init"] = _controller_init;
function _gmaj_program($p) {
 var label = 0;
 var $1;
 $1=$p;
 var $2=$1;
 _midi_send_cmd1(12, 0, $2);
 var $3=HEAP8[(40)];
 var $4=(($3)&(255));
 var $5=$4 & 192;
 var $6=(($5) & 255);
...
function _controller_handle() {
 ...
 while(1) switch(label) {
  ...
  case 8: 
   ...
   label = 9; break;
  case 9: 
   var $18=_button_pressed(16);
   var $19=(($18 << 24) >> 24)!=0;
   if ($19) { label = 10; break; } else { label = 11; break; }
  case 10: 
   _gmaj_toggle_cc(4);
   label = 11; break;
  case 11: 
   var $22=_button_pressed(32);
   var $23=(($22 << 24) >> 24)!=0;
   if ($23) { label = 12; break; } else { label = 13; break; }
  case 12: 
   _gmaj_toggle_cc(5);
   label = 13; break;
  case 13: 
   var $26=_button_pressed(256);
   var $27=(($26 << 24) >> 24)!=0;
   if ($27) { label = 14; break; } else { label = 15; break; }
  case 14: 
   _rjm_program(0);
   var $29=HEAP8[(56)];
   _gmaj_program($29);
  ...
  case 16: 
   ...
   label = 17; break;
  case 17: 
   var $36=_button_pressed(1024);
   var $37=(($36 << 24) >> 24)!=0;
   if ($37) { label = 18; break; } else { label = 19; break; }
  case 18: 
   _rjm_program(2);
   var $39=HEAP8[(56)];
   _gmaj_program($39);
   ...
   label = 19; break;
  case 19: 
   var $41=_button_pressed(2048);
   var $42=(($41 << 24) >> 24)!=0;
   if ($42) { label = 20; break; } else { label = 21; break; }
  case 20: 
   _rjm_program(3);
   var $44=HEAP8[(56)];
   _gmaj_program($44);
   ...
   label = 21; break;
  case 21: 
   var $46=_button_pressed(4096);
   var $47=(($46 << 24) >> 24)!=0;
   if ($47) { label = 22; break; } else { label = 23; break; }
  case 22: 
   _rjm_program(4);
   var $49=HEAP8[(56)];
   _gmaj_program($49);
   ...
   label = 23; break;
  case 23: 
   var $51=_button_pressed(8192);
   var $52=(($51 << 24) >> 24)!=0;
   if ($52) { label = 24; break; } else { label = 25; break; }
  case 24: 
   _rjm_program(5);
   var $54=HEAP8[(56)];
   _gmaj_program($54);
   ...
   label = 25; break;
  case 25: 
   var $56=_button_pressed(64);
   var $57=(($56 << 24) >> 24)!=0;
   if ($57) { label = 26; break; } else { label = 27; break; }
  case 26: 
   var $59=HEAP8[(40)];
   var $60=(($59)&(255));
   var $61=$60 ^ 64;
  ...
  case 28: 
   ...
   label = 29; break;
  case 29: 
   var $82=_button_pressed(128);
   var $83=(($82 << 24) >> 24)!=0;
   if ($83) { label = 30; break; } else { label = 33; break; }
  case 30: 
   var $85=HEAP8[(56)];
   var $86=(($85)&(255));
   var $87=(($86)|(0))!=0;
   if ($87) { label = 31; break; } else { label = 32; break; }
  case 31: 
   var $89=HEAP8[(56)];
   var $90=((($89)-(1))&255);
   HEAP8[(56)]=$90;
  ...
  case 32: 
   ...
   label = 33; break;
  case 33: 
   var $94=_button_pressed(-32768);
   var $95=(($94 << 24) >> 24)!=0;
   if ($95) { label = 34; break; } else { label = 37; break; }
  case 34: 
   var $97=HEAP8[(56)];
   var $98=(($97)&(255));
   var $99=(($98)|(0))!=127;
...
Module["_controller_handle"] = _controller_handle;
...
// {{POST_RUN_ADDITIONS}}
// {{MODULE_ADDITIONS}}
//@ sourceMappingURL=eminorv2.js.map
...
1)d(c)}}function e(a,d){var c=32-d;return a<<c>>c}function f(a,d){var c=32-d;return a<<c>>>c}function g(a){return[a&255]}function n(a){return e(a[0],8)}function ma(a){return[a&255]}function Oa(a){return f(a[0],8)}function Na(a){a=lb(Number(a));return[0>a?0:255<a?255:a&255]}function Sa(a){return[a>>8&255,a&255]}function Va(a){return e(a[0]<<8|a[1],16)}function ab(a){return[a>>8&255,a&255]}function Ya(a){return f(a[0]<<8|a[1],16)}function Za(a){return[a>>24&255,a>>16&255,a>>8&255,a&255]}function bb(a){return e(a[0]<<
24|a[1]<<16|a[2]<<8|a[3],32)}function db(a){return[a>>24&255,a>>16&255,a>>8&255,a&255]}function Ta(a){return f(a[0]<<24|a[1]<<16|a[2]<<8|a[3],32)}function p(a,d,c){function e(a){var d=G(a);a-=d;return 0.5>a?d:0.5<a?d+1:d%2?d+1:d}var f=(1<<d-1)-1,n,g,p;a!==a?(g=(1<<d)-1,p=Wa(2,c-1),n=0):Infinity===a||-Infinity===a?(g=(1<<d)-1,p=0,n=0>a?1:0):0===a?(p=g=0,n=-Infinity===1/a?1:0):(n=0>a,a=hb(a),a>=Wa(2,1-f)?(g=eb(G(Ua(a)/Xa),1023),p=e(a/Wa(2,g)*Wa(2,c)),2<=p/Wa(2,c)&&(g+=1,p=1),g>f?(g=(1<<d)-1,p=0):(g+=
f,p-=Wa(2,c))):(g=0,p=e(a/Wa(2,1-f-c))));for(a=[];c;c-=1)a.push(p%2?1:0),p=G(p/2);for(c=d;c;c-=1)a.push(g%2?1:0),g=G(g/2);a.push(n?1:0);a.reverse();d=a.join("");for(n=[];d.length;)n.push(parseInt(d.substring(0,8),2)),d=d.substring(8);return n}function Qa(a,d,c){var e=[],G,f,n;for(G=a.length;G;G-=1)for(n=a[G-1],f=8;f;f-=1)e.push(n%2?1:0),n>>=1;e.reverse();f=e.join("");a=(1<<d-1)-1;e=parseInt(f.substring(0,1),2)?-1:1;G=parseInt(f.substring(1,1+d),2);f=parseInt(f.substring(1+d),2);return G===(1<<d)-
1?0!==f?NaN:Infinity*e:0<G?e*Wa(2,G-a)*(1+f/Wa(2,c)):0!==f?e*Wa(2,-(a-1))*(f/Wa(2,c)):0>e?-0:0}function Pa(a){return Qa(a,11,52)}function $a(a){return p(a,11,52)}function cb(a){return Qa(a,8,23)}function fb(a){return p(a,8,23)}var ib=void 0,gb=1E5,Ra=function(){var a=Object.prototype.toString,d=Object.prototype.hasOwnProperty;return{Class:function(d){return a.call(d).replace(/^\[object *|\]$/g,"")},HasProperty:function(a,d){return d in a},HasOwnProperty:function(a,c){return d.call(a,c)},IsCallable:function(a){return"function"===
typeof a},ToInt32:function(a){return a>>0},ToUint32:function(a){return a>>>0}}}(),Xa=Math.LN2,hb=Math.abs,G=Math.floor,Ua=Math.log,eb=Math.min,Wa=Math.pow,lb=Math.round,jb;if(!(jb=!Object.defineProperty)){var kb;try{Object.defineProperty({},"x",{}),kb=!0}catch(mb){kb=!1}jb=!kb}jb&&(Object.defineProperty=function(a,d,c){if(!a===Object(a))throw new TypeError("Object.defineProperty called on non-object");Ra.HasProperty(c,"get")&&Object.prototype.__defineGetter__&&Object.prototype.__defineGetter__.call(a,
d,c.get);Ra.HasProperty(c,"set")&&Object.prototype.__defineSetter__&&Object.prototype.__defineSetter__.call(a,d,c.set);Ra.HasProperty(c,"value")&&(a[d]=c.value);return a});Object.getOwnPropertyNames||(Object.getOwnPropertyNames=function(a){if(a!==Object(a))throw new TypeError("Object.getOwnPropertyNames called on non-object");var d=[],c;for(c in a)Ra.HasOwnProperty(a,c)&&d.push(c);return d});(function(){function e(a,n,g){var p;p=function(a,e,f){var n,g,Ua;if(arguments.length&&"number"!==typeof arguments[0])if("object"===
...
n),Ua=e(1,ma,Oa),gb=e(1,Na,Oa),eb=e(2,Sa,Va),Xa=e(2,ab,Ya),Wa=e(4,Za,bb),Qa=e(4,db,Ta),hb=e(4,fb,cb),jb=e(8,$a,Pa);a.Int8Array=a.Int8Array||p;a.Uint8Array=a.Uint8Array||Ua;a.Uint8ClampedArray=a.Uint8ClampedArray||gb;a.Int16Array=a.Int16Array||eb;a.Uint16Array=a.Uint16Array||Xa;a.Int32Array=a.Int32Array||Wa;a.Uint32Array=a.Uint32Array||Qa;a.Float32Array=a.Float32Array||hb;a.Float64Array=a.Float64Array||jb})();(function(){function c(a,d){return Ra.IsCallable(a.get)?a.get(d):a[d]}function e(a){return function(d,
...
typeof c[0]&&(Oa.appendChild(document.createTextNode(c.shift().replace(e,Na))),Oa.appendChild(document.createTextNode(" ")));for(;c.length;)Oa.appendChild(a(c.shift())),Oa.appendChild(document.createTextNode(" "));for((Sa.length?Sa[Sa.length-1]:ma).appendChild(Oa);ma.children.length>d;)ma.removeChild(ma.firstChild);ma.scrollTop=ma.scrollHeight;ma.style.visibility="visible"}}function n(a){var d=[],c;for(c=0;c<a.length;c+=1)d[c]=a[c];return d}(function(){var a=document.createElement("style");(document.getElementsByTagName("HEAD")[0]||
...
c==e?!1:a<=d&&c>=e;e&&(delete Za[Ta][d],delete Ya[Ta][d]);e=Za[Ta][d];e=a>=d&&a<e?!0:c>d&&c<e;if(e)return!0}return!1}function f(a,c){return'<span class="'+a.replace(/\./g," ")+($a?" "+$a:"")+'">'+c+"</span>"}function g(a,c,d,p){if("undefined"===typeof a||null===a)return p();var Xa=a.exec(d);if(!Xa)return p();++Qa;c.name||"string"!=typeof c.matches[0]||(c.name=c.matches[0],delete c.matches[0]);var Na=Xa[0],G=Xa.index,Ua=Xa[0].length+G,eb=function(){var e=function(){g(a,c,d,p)};return 0<Qa%100?e():
setTimeout(e,0)};if(e(G,Ua))return eb();var Wa=ma(c.matches),Pa=function(a,d,e){if(a>=d.length)return e(Na);var G=Xa[d[a]];if(G){var g=c.matches[d[a]],p=g.language,Ua=g.name&&g.matches?g.matches:g,ma=function(c,G,g){var p=0,Ua;for(Ua=1;Ua<d[a];++Ua)Xa[Ua]&&(p+=Xa[Ua].length);Na=n(p,c,g?f(g,G):G,Na);Pa(++a,d,e)};if(p)return Sa(G,p,function(a){ma(G,a)});if("string"===typeof g)return ma(G,G,g);Oa(G,Ua.length?Ua:[Ua],function(a){ma(G,a,g.matches?g.name:0)})}else Pa(++a,d,e)};Pa(0,Wa,function(a){c.name&&
(a=f(c.name,a));Ya[Ta]||(Ya[Ta]={},Za[Ta]={});Ya[Ta][G]={replace:Xa[0],"with":a};Za[Ta][G]=Ua;eb()})}function n(a,c,d,e){var f=e.substr(a);return e.substr(0,a)+f.replace(c,d)}function ma(a){var c=[],d;for(d in a)a.hasOwnProperty(d)&&c.push(d);return c.sort(function(a,c){return c-a})}function Oa(a,c,d){function e(c,f){if(f<c.length)return g(c[f].pattern,c[f],a,function(){e(c,++f)});Na(a,function(a){delete Ya[Ta];delete Za[Ta];--Ta;d(a)})}++Ta;e(c,0)}function Na(a,c){function d(a,c,e,f){if(e<c.length){++Pa;
var g=c[e],p=Ya[Ta][g];a=n(g,p.replace,p["with"],a);g=function(){d(a,c,++e,f)};return 0<Pa%250?g():setTimeout(g,0)}f(a)}var e=ma(Ya[Ta]);d(a,e,0,c)}function Sa(a,c,d){var e=bb[c]||[],f=bb[p]||[];c=db[c]?e:e.concat(f);Oa(a.replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/&(?![\w\#]+;)/g,"&amp;"),c,d)}function Va(a,e,f){if(e<a.length){var g=a[e],n=c(g);return-1<(" "+g.className+" ").indexOf(" rainbow ")||!n?Va(a,++e,f):(n=n.toLowerCase(),d(g,"rainbow"),Sa(g.innerHTML,n,function(c){g.innerHTML=c;Ya=
{};Za={};cb&&cb(g,n);setTimeout(function(){Va(a,++e,f)},0)}))}f&&f()}function ab(a,c){a=a&&"function"==typeof a.getElementsByTagName?a:document;var d=a.getElementsByTagName("pre"),e=a.getElementsByTagName("code"),f,g=[],G=[];for(f=0;f<d.length;++f)d[f].getElementsByTagName("code").length?d[f].innerHTML=d[f].innerHTML.replace(/^\s+/,"").replace(/\s+$/,""):g.push(d[f]);for(f=0;f<e.length;++f)G.push(e[f]);Va(G.concat(g),0,c)}var Ya={},Za={},bb={},db={},Ta=0,p=0,Qa=0,Pa=0,$a,cb;return{extend:function(a,
c,d){1==arguments.length&&(c=a,a=p);db[a]=d;bb[a]=c.concat(bb[a]||[])},onHighlight:function(a){cb=a},addClass:function(a){$a=a},color:function(a,c,d){if("string"==typeof a)return Sa(a,c,d);if("function"==typeof a)return ab(0,a);ab(a,c)}}}();(function(){if(document.addEventListener)return document.addEventListener("DOMContentLoaded",Rainbow.color,!1);window.attachEvent("onload",Rainbow.color)})();Rainbow.onHighlight=Rainbow.onHighlight;Rainbow.addClass=Rainbow.addClass;Rainbow.extend("c",[{name:"meta.preprocessor",matches:{1:[{matches:{1:"keyword.define",2:"entity.name"},pattern:/(\w+)\s(\w+)\b/g},{name:"keyword.define",pattern:/endif/g},{name:"constant.numeric",pattern:/\d+/g},{matches:{1:"keyword.include",2:"string"},pattern:/(include)\s(.*?)$/g}]},pattern:/\#([\S\s]*?)$/gm},{name:"keyword",pattern:/\b(do|goto|typedef)\b/g},{name:"entity.label",pattern:/\w+:/g},{matches:{1:"storage.type",3:"storage.type",4:"entity.name.function"},pattern:/\b((un)?signed|const)? ?(void|char|short|int|long|float|double)\*? +((\w+)(?= ?\())?/g},
...
j.removeRunDependency=function(a){U--;j.monitorRunDependencies&&j.monitorRunDependencies(U);a?(B(V[a]),delete V[a]):j.a("warning: run dependency removed without ID");0==U&&(W!==h&&(clearInterval(W),W=h),!Da&&X&&Y())};j.preloadedImages={};j.preloadedAudios={};va=8;u=va+272;R.push({c:function(){Ea()}});
...
var Ja=Math.min,Z=function(a,d,c){function e(a){a|=0;var c=0;if((p[268]&a)<<24>>24!=a<<24>>24)return 0;c=0==(p[260]&a)<<24>>24|0;return c|0}function f(a){a|=0;var c=0;if((p[260]&a)<<24>>24!=a<<24>>24)return 0;c=0==(p[268]&a)<<24>>24|0;return c|0}function g(a){a|=0;var c=0;if((p[264]&a)<<24>>24!=a<<24>>24)return 0;c=0==(p[256]&a)<<24>>24|0;return c|0}function n(){var a=0;_midi_send_cmd1(12,0,p[200]|0);a=p[200]|0;p[248]=a;p[208]=a;_flash_load((Pa[248]|0)<<5,32,168);_midi_send_cmd1(12,1,(p[174]|0)+4&
255);Sa();p[216]=(p[216]&192|1<<(Pa[174]|0))&255;ma()}function ma(){var a=0,c=0,d=0,e=0;_led_set((Pa[220]|0)<<8|Pa[216]|0);a=19;for(c=(p[248]|0)+1&255;;)if(d=a-1&255,p[224+(a&255)|0]=(c&255)%10|48,9<(c&255))a=d,c=(c&255)/10|0;else{e=d;break}for(;;)if(p[224+(e&255)|0]=32,17<(e&255))e=e-1&255;else break;_lcd_update_row(2,224);_lcd_update_row(3,176)}function Oa(){var a=0,a=Qa[55]|0;0!=(a&64|0)&&(Qa[55]=a&-65,Na(81,0),ma())}function Na(a,c){_midi_send_cmd2(11,0,a|0,c|0)}function Sa(){var a=0,c=0,a=p[168+
(Pa[174]|0)|0]|0,c=a&255;p[220]=p[220]&-64|a&63;0!=(c&64|0)&&Na(90,127);0!=(c&16|0)&&Na(88,127);0!=(c&32|0)&&Na(89,127);0!=(c&4|0)&&Na(86,127);0!=(c&2|0)&&Na(85,127);0!=(c&8|0)&&Na(87,127);0!=(c&1|0)&&Na(84,127);0!=(c&128|0)&&Na(91,127)}function Va(a){a|=0;var c=0,d=0,c=a&255;6>(a&255)?(a=1<<c,d=168+(Pa[174]|0)|0,p[d]=((Pa[d]|0)^a)&255,Na(p[24+c|0]|0,0==(a&(Pa[168+(Pa[174]|0)|0]|0)|0)?0:127),p[220]=p[220]&-64|p[168+(Pa[174]|0)|0]&63,ma()):ib(48,166,120,32)}function ab(a){a|=0;6>(a&255)?(p[174]=a,
_midi_send_cmd1(12,1,a+4&255),_midi_send_cmd1(12,0,p[248]|0),p[208]=p[248]|0,Sa(),p[216]=(p[216]&192|1<<(a&255))&255,ma()):ib(48,229,104,40)}function Ya(a,c,d){a|=0;c|=0;d|=0;var e=0,e=a|0;if((a&3)==(c&3)){for(;a&3;){if(0==(d|0))return e|0;p[a]=p[c]|0;a=a+1|0;c=c+1|0;d=d-1|0}for(;4<=(d|0);)Qa[a>>2]=Qa[c>>2],a=a+4|0,c=c+4|0,d=d-4|0}for(;0<(d|0);)p[a]=p[c]|0,a=a+1|0,c=c+1|0,d=d-1|0;return e|0}function Za(a){fb(0);return 0}function bb(){fb(1)}function db(a,c){fb(2);return 0}function Ta(a){fb(3)}"use asm";
var p=new a.Int8Array(c);new a.Int16Array(c);var Qa=new a.Int32Array(c),Pa=new a.Uint8Array(c);new a.Uint16Array(c);new a.Uint32Array(c);new a.Float32Array(c);new a.Float64Array(c);var $a=d.STACKTOP|0,cb=0,fb=d.abort,ib=d.___assert_func,gb=[Za,Za],Ra=[bb,bb],Xa=[db,db],hb=[Ta,Ta];return{_strlen:function(a){a|=0;for(var c=0,c=a;p[c]|0;)c=c+1|0;return c-a|0},_controller_handle:function(){var a=0,c=a=0,d=c=a=c=a=c=a=a=0,a=_fsw_poll()|0;p[264]=a&255;p[268]=(a&65535)>>>8&255;0==(e(1)|0)<<24>>24?(a=0!=
(f(1)|0)<<24>>24,a&30<(Pa[152]|0)&&(p[152]=0,Va(0))):(Va(0),p[152]=1);0==(e(2)|0)<<24>>24?(a=0!=(f(2)|0)<<24>>24,a&30<(Pa[152]|0)&&(p[152]=0,Va(1))):(Va(1),p[152]=1);0==(e(4)|0)<<24>>24?(a=0!=(f(4)|0)<<24>>24,a&30<(Pa[152]|0)&&(p[152]=0,Va(2))):(Va(2),p[152]=1);0==(e(8)|0)<<24>>24?(a=0!=(f(8)|0)<<24>>24,a&30<(Pa[152]|0)&&(p[152]=0,Va(3))):(Va(3),p[152]=1);0==(e(16)|0)<<24>>24?(a=0!=(f(16)|0)<<24>>24,a&30<(Pa[152]|0)&&(p[152]=0,Va(4))):(Va(4),p[152]=1);0==(e(32)|0)<<24>>24?(a=0!=(f(32)|0)<<24>>24,
a&30<(Pa[152]|0)&&(p[152]=0,Va(5))):(Va(5),p[152]=1);0!=(g(1)|0)<<24>>24&&(ab(0),Oa());0!=(g(2)|0)<<24>>24&&(ab(1),Oa());0!=(g(4)|0)<<24>>24&&(ab(2),Oa());0!=(g(8)|0)<<24>>24&&(ab(3),Oa());0!=(g(16)|0)<<24>>24&&(ab(4),Oa());0!=(g(32)|0)<<24>>24&&(ab(5),Oa());0!=(e(64)|0)<<24>>24&&(p[220]^=64,Na(81,0!=(Qa[55]&64|0)?127:0));0==(g(64)|0)<<24>>24?59>=(Pa[144]|0)||0==(Qa[66]&64|0)||(_flash_store((Pa[248]|0)<<5,32,168),p[160]=80,p[144]=0):(a=p[136]&127^127,p[136]=a,Na(80,a),p[144]=1);Qa[54]=Qa[54]&-65|
Qa[66]&64;0!=(e(-128)|0)<<24>>24&&(a=p[200]|0,0!=a<<24>>24&&(p[200]=a-1&255),n());0!=(g(-128)|0)<<24>>24&&(a=p[200]|0,127!=a<<24>>24&&(p[200]=a+1&255),n());a=Qa[67]|0;c=Qa[55]|0;a=c&-129|a&128;Qa[55]=a;a=Qa[66]|0;c=Qa[54]|0;a=c&-129|a&128;Qa[54]=a;ma();c=264;a=Qa[(c|0)>>2]|0;c=Qa[(c+4|0)>>2]|0;d=256;Qa[(d|0)>>2]=a;Qa[(d+4|0)>>2]=c},_controller_init:function(){p[220]=0;p[216]=0;p[144]=0;p[160]=0;p[174]=0;p[248]=0;p[200]=0;p[208]=0;p[168]=0;p[169]=16;p[170]=0;p[171]=16;p[172]=0;p[173]=16;Ya(224,80,
21)|0;_lcd_update_row(0,272);_lcd_update_row(1,272);_lcd_update_row(2,272);_lcd_update_row(3,176);_flash_load((Pa[248]|0)<<5,32,168);n()},_memset:function(a,c,d){a|=0;c|=0;d|=0;var e=0,f=0,g=0,e=a+d|0;if(20<=(d|0)){c&=255;d=a&3;f=c|c<<8|c<<16|c<<24;g=e&-4;if(d)for(d=a+4-d|0;(a|0)<(d|0);)p[a]=c,a=a+1|0;for(;(a|0)<(g|0);)Qa[a>>2]=f,a=a+4|0}for(;(a|0)<(e|0);)p[a]=c,a=a+1|0},_memcpy:Ya,_controller_10msec_timer:function(){var a=0,c=a=0,d=0,c=0;0!=(Qa[66]&64|0)&&(a=p[144]|0,0!=a<<24>>24&&(p[144]=a+1&255));
a=p[152]|0;0!=a<<24>>24&&(a=a+1&255,p[152]=a,30>=(a&255)||(c=p[168+(Pa[174]|0)|0]|0,d=p[268]|0,c=6<(a&15)>>>0?p[220]&-64|c&63&(d^63):p[220]&-64|(d|c)&63,p[220]=c,ma()));c=p[160]|0;0!=c<<24>>24&&(a=c-1&255,p[160]=a,0==a<<24>>24?p[220]=p[220]&-64|p[168+(Pa[174]|0)|0]&63:(c=p[220]|0,p[220]=6<(a&15)>>>0?c|63:c&-64),ma())},runPostSets:function(){},stackAlloc:function(a){var c=0,c=$a;$a=$a+(a|0)|0;$a=$a+7>>3<<3;return c|0},stackSave:function(){return $a|0},stackRestore:function(a){$a=a|0},setThrew:function(a,
c){0==(cb|0)&&(cb=a|0)},setTempRet0:function(a){},setTempRet1:function(a){},setTempRet2:function(a){},setTempRet3:function(a){},setTempRet4:function(a){},setTempRet5:function(a){},setTempRet6:function(a){},setTempRet7:function(a){},setTempRet8:function(a){},setTempRet9:function(a){},dynCall_ii:function(a,c){return gb[(a|0)&1](c|0)|0},dynCall_v:function(a){Ra[(a|0)&1]()},dynCall_iii:function(a,c,d){return Xa[(a|0)&1](c|0,d|0)|0},dynCall_vi:function(a,c){hb[(a|0)&1](c|0)}}}({Math:Math,Int8Array:Int8Array,
Int16Array:Int16Array,Int32Array:Int32Array,Uint8Array:Uint8Array,Uint16Array:Uint16Array,Uint32Array:Uint32Array,Float32Array:Float32Array,Float64Array:Float64Array},{abort:x,assert:B,asmPrintInt:function(a,d){j.print("int "+a+","+d)},asmPrintFloat:function(a,d){j.print("float "+a+","+d)},min:Ja,invoke_ii:function(a,d){try{return j.dynCall_ii(a,d)}catch(c){if("number"!==typeof c&&"longjmp"!==c)throw c;Z.setThrew(1,0)}},invoke_v:function(a){try{j.dynCall_v(a)}catch(d){if("number"!==typeof d&&"longjmp"!==
d)throw d;Z.setThrew(1,0)}},invoke_iii:function(a,d,c){try{return j.dynCall_iii(a,d,c)}catch(e){if("number"!==typeof e&&"longjmp"!==e)throw e;Z.setThrew(1,0)}},invoke_vi:function(a,d){try{j.dynCall_vi(a,d)}catch(c){if("number"!==typeof c&&"longjmp"!==c)throw c;Z.setThrew(1,0)}},_malloc:sa,___assert_func:function(a,d,c,e){throw"Assertion failed: "+(e?C(e):"unknown condition")+", at: "+[a?C(a):"unknown filename",d,c?C(c):"unknown function"]+" at "+Error().stack;},_free:function(){},STACKTOP:s,STACK_MAX:N,
tempDoublePtr:Fa,ABORT:z,NaN:NaN,Infinity:Infinity},O),Ia=j._strlen=Z._strlen;j._controller_handle=Z._controller_handle;j._controller_init=Z._controller_init;var Ha=j._memset=Z._memset,Ga=j._memcpy=Z._memcpy;j._controller_10msec_timer=Z._controller_10msec_timer;var Ea=j.runPostSets=Z.runPostSets;j.dynCall_ii=Z.dynCall_ii;j.dynCall_v=Z.dynCall_v;j.dynCall_iii=Z.dynCall_iii;j.dynCall_vi=Z.dynCall_vi;t=function(a){return Z.stackAlloc(a)};r=function(){return Z.stackSave()};fa=function(a){Z.stackRestore(a)};
function Ka(a){this.name="ExitStatus";this.message="Program terminated with exit("+a+")";this.status=a}Ka.prototype=Error();var La,$=h;
...
function _flash_load(a,d,c){var e=localStorage.getItem("flash");if(void 0===e||null===e||e.length<2*flash_size)e="",localStorage.setItem("flash",

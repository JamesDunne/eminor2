...
item:{value:function(n){var g=f(a[d]);return 0<=n&&n<g.length?g[n]:null}},contains:{value:function(n){n=String(n);if(0===n.length)throw new SyntaxError;if(/\s/.test(n))throw Error("InvalidCharacterError");return-1!==f(a[d]).indexOf(n)}},add:{value:function(n){tokens=Array.prototype.slice.call(arguments).map(String);if(tokens.some(function(a){return 0===a.length}))throw new SyntaxError;if(tokens.some(function(a){return/\s/.test(a)}))throw Error("InvalidCharacterError");try{var g=a[d],Na=f(g);tokens=
tokens.filter(function(a){return-1===Na.indexOf(a)});0!==tokens.length&&(0===g.length||/\s$/.test(g)||(g+=" "),g+=tokens.join(" "),a[d]=g)}finally{g=f(a[d]).length,this.length!==g&&(this.length=g)}}},remove:{value:function(n){tokens=Array.prototype.slice.call(arguments).map(String);if(tokens.some(function(a){return 0===a.length}))throw new SyntaxError;if(tokens.some(function(a){return/\s/.test(a)}))throw Error("InvalidCharacterError");try{var Pa=a[d];tokens.forEach(function(a){Pa=g(a,Pa)});a[d]=Pa}finally{var Na=
f(a[d]).length;this.length!==Na&&(this.length=Na)}}},toggle:{value:function(n,Pa){try{n=String(n);if(0===n.length)throw new SyntaxError;if(/\s/.test(n))throw Error("InvalidCharacterError");var Na=f(a[d]).indexOf(n);if(-1!==Na&&(!Pa||void 0===Pa))return a[d]=g(n,a[d]),!1;if(-1!==Na&&Pa)return!0;var Ra=a[d];0===Ra.length||/\s$/.test(Ra)||(Ra+=" ");a[d]=Ra+n;return!0}finally{Na=f(a[d]).length,this.length!==Na&&(this.length=Na)}}},toString:{value:function(){return a[d]}}});if("length"in this)for(var n=
...
"\\x"+("00"+d.charCodeAt(0).toString(16).toUpperCase()).slice(-2):"\\u"+("0000"+d.charCodeAt(0).toString(16).toUpperCase()).slice(-4)})+'"'}})();(function(a){function d(a){if(Object.getOwnPropertyNames&&Object.defineProperty){var d=Object.getOwnPropertyNames(a),c;for(c=0;c<d.length;c+=1)Object.defineProperty(a,d[c],{value:a[d[c]],writable:!1,enumerable:!1,configurable:!1})}}function c(a){function d(c){Object.defineProperty(a,c,{get:function(){return a._getter(c)},set:function(d){a._setter(c,d)},enumerable:!0,configurable:!1})}if(Object.defineProperty){if(a.length>fb)throw new RangeError("Array too large for polyfill");var c;for(c=0;c<a.length;c+=
1)d(c)}}function e(a,d){var c=32-d;return a<<c>>c}function f(a,d){var c=32-d;return a<<c>>>c}function g(a){return[a&255]}function n(a){return e(a[0],8)}function ma(a){return[a&255]}function Pa(a){return f(a[0],8)}function Na(a){a=lb(Number(a));return[0>a?0:255<a?255:a&255]}function Ra(a){return[a>>8&255,a&255]}function Ua(a){return e(a[0]<<8|a[1],16)}function $a(a){return[a>>8&255,a&255]}function Wa(a){return f(a[0]<<8|a[1],16)}function Xa(a){return[a>>24&255,a>>16&255,a>>8&255,a&255]}function bb(a){return e(a[0]<<
24|a[1]<<16|a[2]<<8|a[3],32)}function db(a){return[a>>24&255,a>>16&255,a>>8&255,a&255]}function p(a){return f(a[0]<<24|a[1]<<16|a[2]<<8|a[3],32)}function Qa(a,d,c){function e(a){var d=Sa(a);a-=d;return 0.5>a?d:0.5<a?d+1:d%2?d+1:d}var f=(1<<d-1)-1,n,g,p;a!==a?(g=(1<<d)-1,p=Ya(2,c-1),n=0):Infinity===a||-Infinity===a?(g=(1<<d)-1,p=0,n=0>a?1:0):0===a?(p=g=0,n=-Infinity===1/a?1:0):(n=0>a,a=G(a),a>=Ya(2,1-f)?(g=jb(Sa(eb(a)/Va),1023),p=e(a/Ya(2,g)*Ya(2,c)),2<=p/Ya(2,c)&&(g+=1,p=1),g>f?(g=(1<<d)-1,p=0):(g+=
f,p-=Ya(2,c))):(g=0,p=e(a/Ya(2,1-f-c))));for(a=[];c;c-=1)a.push(p%2?1:0),p=Sa(p/2);for(c=d;c;c-=1)a.push(g%2?1:0),g=Sa(g/2);a.push(n?1:0);a.reverse();d=a.join("");for(n=[];d.length;)n.push(parseInt(d.substring(0,8),2)),d=d.substring(8);return n}function Ta(a,d,c){var e=[],G,f,n;for(G=a.length;G;G-=1)for(n=a[G-1],f=8;f;f-=1)e.push(n%2?1:0),n>>=1;e.reverse();f=e.join("");a=(1<<d-1)-1;e=parseInt(f.substring(0,1),2)?-1:1;G=parseInt(f.substring(1,1+d),2);f=parseInt(f.substring(1+d),2);return G===(1<<d)-
1?0!==f?NaN:Infinity*e:0<G?e*Ya(2,G-a)*(1+f/Ya(2,c)):0!==f?e*Ya(2,-(a-1))*(f/Ya(2,c)):0>e?-0:0}function Za(a){return Ta(a,11,52)}function cb(a){return Qa(a,11,52)}function ab(a){return Ta(a,8,23)}function hb(a){return Qa(a,8,23)}var ib=void 0,fb=1E5,Oa=function(){var a=Object.prototype.toString,d=Object.prototype.hasOwnProperty;return{Class:function(d){return a.call(d).replace(/^\[object *|\]$/g,"")},HasProperty:function(a,d){return d in a},HasOwnProperty:function(a,c){return d.call(a,c)},IsCallable:function(a){return"function"===
typeof a},ToInt32:function(a){return a>>0},ToUint32:function(a){return a>>>0}}}(),Va=Math.LN2,G=Math.abs,Sa=Math.floor,eb=Math.log,jb=Math.min,Ya=Math.pow,lb=Math.round,gb;if(!(gb=!Object.defineProperty)){var kb;try{Object.defineProperty({},"x",{}),kb=!0}catch(mb){kb=!1}gb=!kb}gb&&(Object.defineProperty=function(a,d,c){if(!a===Object(a))throw new TypeError("Object.defineProperty called on non-object");Oa.HasProperty(c,"get")&&Object.prototype.__defineGetter__&&Object.prototype.__defineGetter__.call(a,
d,c.get);Oa.HasProperty(c,"set")&&Object.prototype.__defineSetter__&&Object.prototype.__defineSetter__.call(a,d,c.set);Oa.HasProperty(c,"value")&&(a[d]=c.value);return a});Object.getOwnPropertyNames||(Object.getOwnPropertyNames=function(a){if(a!==Object(a))throw new TypeError("Object.getOwnPropertyNames called on non-object");var d=[],c;for(c in a)Oa.HasOwnProperty(a,c)&&d.push(c);return d});(function(){function e(a,n,g){var p;p=function(a,e,G){var n,g,Sa;if(arguments.length&&"number"!==typeof arguments[0])if("object"===
typeof arguments[0]&&arguments[0].constructor===p)for(n=arguments[0],this.length=n.length,this.byteLength=this.length*this.BYTES_PER_ELEMENT,this.buffer=new f(this.byteLength),g=this.byteOffset=0;g<this.length;g+=1)this._setter(g,n._getter(g));else if("object"!==typeof arguments[0]||arguments[0]instanceof f||"ArrayBuffer"===Oa.Class(arguments[0]))if("object"===typeof arguments[0]&&(arguments[0]instanceof f||"ArrayBuffer"===Oa.Class(arguments[0]))){this.buffer=a;this.byteOffset=Oa.ToUint32(e);if(this.byteOffset>
this.buffer.byteLength)throw new RangeError("byteOffset out of range");if(this.byteOffset%this.BYTES_PER_ELEMENT)throw new RangeError("ArrayBuffer length minus the byteOffset is not a multiple of the element size.");if(3>arguments.length){this.byteLength=this.buffer.byteLength-this.byteOffset;if(this.byteLength%this.BYTES_PER_ELEMENT)throw new RangeError("length of buffer minus byteOffset not a multiple of the element size");this.length=this.byteLength/this.BYTES_PER_ELEMENT}else this.length=Oa.ToUint32(G),
this.byteLength=this.length*this.BYTES_PER_ELEMENT;if(this.byteOffset+this.byteLength>this.buffer.byteLength)throw new RangeError("byteOffset and length reference an area beyond the end of the buffer");}else throw new TypeError("Unexpected argument type(s)");else for(n=arguments[0],this.length=Oa.ToUint32(n.length),this.byteLength=this.length*this.BYTES_PER_ELEMENT,this.buffer=new f(this.byteLength),g=this.byteOffset=0;g<this.length;g+=1)Sa=n[g],this._setter(g,Number(Sa));else{this.length=Oa.ToInt32(arguments[0]);
if(0>G)throw new RangeError("ArrayBufferView size is not a small enough positive integer.");this.byteLength=this.length*this.BYTES_PER_ELEMENT;this.buffer=new f(this.byteLength);this.byteOffset=0}this.constructor=p;d(this);c(this)};p.prototype=new G;p.prototype.BYTES_PER_ELEMENT=a;p.prototype._pack=n;p.prototype._unpack=g;p.BYTES_PER_ELEMENT=a;p.prototype._getter=function(a){if(1>arguments.length)throw new SyntaxError("Not enough arguments");a=Oa.ToUint32(a);if(a>=this.length)return ib;var d=[],c,
e;c=0;for(e=this.byteOffset+a*this.BYTES_PER_ELEMENT;c<this.BYTES_PER_ELEMENT;c+=1,e+=1)d.push(this.buffer._bytes[e]);return this._unpack(d)};p.prototype.get=p.prototype._getter;p.prototype._setter=function(a,d){if(2>arguments.length)throw new SyntaxError("Not enough arguments");a=Oa.ToUint32(a);if(a>=this.length)return ib;var c=this._pack(d),e,f;e=0;for(f=this.byteOffset+a*this.BYTES_PER_ELEMENT;e<this.BYTES_PER_ELEMENT;e+=1,f+=1)this.buffer._bytes[f]=c[e]};p.prototype.set=function(a,d){if(1>arguments.length)throw new SyntaxError("Not enough arguments");
var c,e,f,G,n,g;if("object"===typeof arguments[0]&&arguments[0].constructor===this.constructor){c=arguments[0];e=Oa.ToUint32(arguments[1]);if(e+c.length>this.length)throw new RangeError("Offset plus length of array is out of range");g=this.byteOffset+e*this.BYTES_PER_ELEMENT;e=c.length*this.BYTES_PER_ELEMENT;if(c.buffer===this.buffer){f=[];G=0;for(n=c.byteOffset;G<e;G+=1,n+=1)f[G]=c.buffer._bytes[n];for(G=0;G<e;G+=1,g+=1)this.buffer._bytes[g]=f[G]}else for(G=0,n=c.byteOffset;G<e;G+=1,n+=1,g+=1)this.buffer._bytes[g]=
c.buffer._bytes[n]}else if("object"===typeof arguments[0]&&"undefined"!==typeof arguments[0].length){c=arguments[0];f=Oa.ToUint32(c.length);e=Oa.ToUint32(arguments[1]);if(e+f>this.length)throw new RangeError("Offset plus length of array is out of range");for(G=0;G<f;G+=1)n=c[G],this._setter(e+G,Number(n))}else throw new TypeError("Unexpected argument type(s)");};p.prototype.subarray=function(a,d){a=Oa.ToInt32(a);d=Oa.ToInt32(d);1>arguments.length&&(a=0);2>arguments.length&&(d=this.length);0>a&&(a=
this.length+a);0>d&&(d=this.length+d);var c=this.length;a=0>a?0:a>c?c:a;c=this.length;c=(0>d?0:d>c?c:d)-a;0>c&&(c=0);return new this.constructor(this.buffer,this.byteOffset+a*this.BYTES_PER_ELEMENT,c)};return p}var f=function(a){a=Oa.ToInt32(a);if(0>a)throw new RangeError("ArrayBuffer size is not a small enough positive integer.");this.byteLength=a;this._bytes=[];this._bytes.length=a;for(a=0;a<this.byteLength;a+=1)this._bytes[a]=0;d(this)};a.ArrayBuffer=a.ArrayBuffer||f;var G=function(){},Sa=e(1,
g,n),fb=e(1,ma,Pa),Va=e(1,Na,Pa),eb=e(2,Ra,Ua),Qa=e(2,$a,Wa),Ya=e(4,Xa,bb),Ta=e(4,db,p),jb=e(4,hb,ab),gb=e(8,cb,Za);a.Int8Array=a.Int8Array||Sa;a.Uint8Array=a.Uint8Array||fb;a.Uint8ClampedArray=a.Uint8ClampedArray||Va;a.Int16Array=a.Int16Array||eb;a.Uint16Array=a.Uint16Array||Qa;a.Int32Array=a.Int32Array||Ya;a.Uint32Array=a.Uint32Array||Ta;a.Float32Array=a.Float32Array||jb;a.Float64Array=a.Float64Array||gb})();(function(){function c(a,d){return Oa.IsCallable(a.get)?a.get(d):a[d]}function e(a){return function(d,
e){d=Oa.ToUint32(d);if(d+a.BYTES_PER_ELEMENT>this.byteLength)throw new RangeError("Array index out of range");d+=this.byteOffset;var G=new Uint8Array(this.buffer,d,a.BYTES_PER_ELEMENT),n=[],g;for(g=0;g<a.BYTES_PER_ELEMENT;g+=1)n.push(c(G,g));Boolean(e)===Boolean(f)&&n.reverse();return c(new a((new Uint8Array(n)).buffer),0)}}function G(a){return function(d,e,G){d=Oa.ToUint32(d);if(d+a.BYTES_PER_ELEMENT>this.byteLength)throw new RangeError("Array index out of range");e=new a([e]);e=new Uint8Array(e.buffer);
var n=[],g;for(g=0;g<a.BYTES_PER_ELEMENT;g+=1)n.push(c(e,g));Boolean(G)===Boolean(f)&&n.reverse();(new Uint8Array(this.buffer,d,a.BYTES_PER_ELEMENT)).set(n)}}var f=function(){var a=new Uint16Array([4660]),a=new Uint8Array(a.buffer);return 18===c(a,0)}(),n=function(a,c,e){if(0===arguments.length)a=new ArrayBuffer(0);else if(!(a instanceof ArrayBuffer||"ArrayBuffer"===Oa.Class(a)))throw new TypeError("TypeError");this.buffer=a||new ArrayBuffer(0);this.byteOffset=Oa.ToUint32(c);if(this.byteOffset>this.buffer.byteLength)throw new RangeError("byteOffset out of range");
...
g,n){function Pa(a,d,e,f,g,n){if("%"!=d.charAt(0)||!c.length)return d;if("%"===n)return"%";a=c.shift();switch(n){case "s":return String(a);case "d":case "i":case "l":return n=String,a=Number(a),a=0>a?Math.ceil(a):Math.floor(a),n(a);case "f":return String(Number(a));default:case "o":try{return JSON.stringify(a)}catch(ma){return String(a)}}}if(c.length){var Na=document.createElement("div");Na.className="SHIMCONSOLE_"+g;Na.style.whiteSpace="pre";n&&Na.appendChild(document.createTextNode(n));"string"===
typeof c[0]&&(Na.appendChild(document.createTextNode(c.shift().replace(e,Pa))),Na.appendChild(document.createTextNode(" ")));for(;c.length;)Na.appendChild(a(c.shift())),Na.appendChild(document.createTextNode(" "));for((Ra.length?Ra[Ra.length-1]:ma).appendChild(Na);ma.children.length>d;)ma.removeChild(ma.firstChild);ma.scrollTop=ma.scrollHeight;ma.style.visibility="visible"}}function n(a){var c=[],d;for(d=0;d<a.length;d+=1)c[d]=a[d];return c}(function(){var a=document.createElement("style");(document.getElementsByTagName("HEAD")[0]||
document.documentElement).appendChild(a);"styleSheet"in a?a.styleSheet.cssText=c:a.appendChild(document.createTextNode(c))})();var ma,Pa={},Na={},Ra=[];ma=document.createElement("div");ma.id="SHIMCONSOLE";(document.body||document.documentElement).appendChild(ma);this.log=function(a){g(n(arguments),"LOG")};this.debug=function(a){g(n(arguments),"DEBUG")};this.info=function(a){g(n(arguments),"INFO")};this.warn=function(a){g(n(arguments),"WARN","Warning: ")};this.error=function(a){g(n(arguments),"ERROR",
"Error: ")};this.assert=function(a,c){if(!a){var d=n(arguments);d.shift();g(d,"ERROR","Assertion failed: ")}};this.count=function(a){a=a||"";"$"+a in Pa||(Pa["$"+a]=0);Pa["$"+a]+=1;g([a+": "+Pa["$"+a]],"INFO")};this.time=function(a){Na["$"+(a||"")]=Number(new Date)};this.timeEnd=function(a){a=a||"";"$"+a in Na&&(g([a+": "+(Number(new Date)-Na["$"+a])+"ms"],"INFO"),delete Na["$"+a])};this.group=function(a){g([">"+(a||"")],"INFO");a=document.createElement("div");a.className="SHIMCONSOLE_GROUP";(Ra.length?
Ra[Ra.length-1]:ma).appendChild(a);Ra.push(a)};this.groupEnd=function(){Ra.pop()};this.dirxml=this.dir=function(a){g([a],"INFO")};this.trace=function(){try{this.wont.work=0}catch(a){a.stack&&g([a.stack.replace(/^[^\n]*\n/,"Stack trace:\n")],"INFO")}};this.clear=function(){for(;ma.children.length;)ma.removeChild(ma.firstChild)}}var d=1E3,c="#SHIMCONSOLE { visibility: hidden; position: fixed; z-index: 9999; left: 0; right: 0; bottom: 0; height: 200px; border-top: solid 1px #808080; overflow: auto; word-wrap: break-word; padding: 5px; background-color: #eeeeee; color: #000000; font-family: monospace; font-size: 10pt; font-weight: normal; font-style: normal; }#SHIMCONSOLE .SHIMCONSOLE_GROUP { margin-left: 20px; }#SHIMCONSOLE .SHIMCONSOLE_ERROR { color: #ff0000; }#SHIMCONSOLE .SHIMCONSOLE_WARN { color: #ff8000; }",
e=/([^%]|%([\-+0]*)(\d+)?(\.\d+)?([%sdilfox]))/g;window.console=window.console||new a})();/*
 @version 1.2
 @url rainbowco.de
*/
window.Rainbow=function(){function a(a,c,d,e){var f=a.getAttribute&&a.getAttribute(c)||0;if(!f)for(d=a.attributes,e=0;e<d.length;++e)if(d[e].nodeName===c)return d[e].nodeValue;return f}function d(a,c){a.className+=a.className?" "+c:c}function c(c){var d=a(c,"data-language")||a(c.parentNode,"data-language");if(!d){var e=/\blang(?:uage)?-(\w+)/;(c=c.className.match(e)||c.parentNode.className.match(e))&&(d=c[1])}return d}function e(a,c){for(var d in Xa[p]){d=parseInt(d,10);var e;e=Xa[p][d];e=a==d&&c==
e?!1:a<=d&&c>=e;e&&(delete Xa[p][d],delete Wa[p][d]);e=Xa[p][d];e=a>=d&&a<e?!0:c>d&&c<e;if(e)return!0}return!1}function f(a,c){return'<span class="'+a.replace(/\./g," ")+(cb?" "+cb:"")+'">'+c+"</span>"}function g(a,c,d,Oa){if("undefined"===typeof a||null===a)return Oa();var Va=a.exec(d);if(!Va)return Oa();++Ta;c.name||"string"!=typeof c.matches[0]||(c.name=c.matches[0],delete c.matches[0]);var G=Va[0],Sa=Va.index,eb=Va[0].length+Sa,Na=function(){var e=function(){g(a,c,d,Oa)};return 0<Ta%100?e():setTimeout(e,
0)};if(e(Sa,eb))return Na();var Qa=ma(c.matches),Ua=function(a,d,e){if(a>=d.length)return e(G);var g=Va[d[a]];if(g){var p=c.matches[d[a]],Sa=p.language,Oa=p.name&&p.matches?p.matches:p,ma=function(c,g,p){var Sa=0,Oa;for(Oa=1;Oa<d[a];++Oa)Va[Oa]&&(Sa+=Va[Oa].length);G=n(Sa,c,p?f(p,g):g,G);Ua(++a,d,e)};if(Sa)return Ra(g,Sa,function(a){ma(g,a)});if("string"===typeof p)return ma(g,g,p);Pa(g,Oa.length?Oa:[Oa],function(a){ma(g,a,p.matches?p.name:0)})}else Ua(++a,d,e)};Ua(0,Qa,function(a){c.name&&(a=f(c.name,
a));Wa[p]||(Wa[p]={},Xa[p]={});Wa[p][Sa]={replace:Va[0],"with":a};Xa[p][Sa]=eb;Na()})}function n(a,c,d,e){var f=e.substr(a);return e.substr(0,a)+f.replace(c,d)}function ma(a){var c=[],d;for(d in a)a.hasOwnProperty(d)&&c.push(d);return c.sort(function(a,c){return c-a})}function Pa(a,c,d){function e(c,f){if(f<c.length)return g(c[f].pattern,c[f],a,function(){e(c,++f)});Na(a,function(a){delete Wa[p];delete Xa[p];--p;d(a)})}++p;e(c,0)}function Na(a,c){function d(a,c,e,f){if(e<c.length){++Za;var g=c[e],
ma=Wa[p][g];a=n(g,ma.replace,ma["with"],a);g=function(){d(a,c,++e,f)};return 0<Za%250?g():setTimeout(g,0)}f(a)}var e=ma(Wa[p]);d(a,e,0,c)}function Ra(a,c,d){var e=bb[c]||[],f=bb[Qa]||[];c=db[c]?e:e.concat(f);Pa(a.replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/&(?![\w\#]+;)/g,"&amp;"),c,d)}function Ua(a,e,f){if(e<a.length){var g=a[e],n=c(g);return-1<(" "+g.className+" ").indexOf(" rainbow ")||!n?Ua(a,++e,f):(n=n.toLowerCase(),d(g,"rainbow"),Ra(g.innerHTML,n,function(c){g.innerHTML=c;Wa={};Xa={};
ab&&ab(g,n);setTimeout(function(){Ua(a,++e,f)},0)}))}f&&f()}function $a(a,c){a=a&&"function"==typeof a.getElementsByTagName?a:document;var d=a.getElementsByTagName("pre"),e=a.getElementsByTagName("code"),f,G=[],g=[];for(f=0;f<d.length;++f)d[f].getElementsByTagName("code").length?d[f].innerHTML=d[f].innerHTML.replace(/^\s+/,"").replace(/\s+$/,""):G.push(d[f]);for(f=0;f<e.length;++f)g.push(e[f]);Ua(g.concat(G),0,c)}var Wa={},Xa={},bb={},db={},p=0,Qa=0,Ta=0,Za=0,cb,ab;return{extend:function(a,c,d){1==
arguments.length&&(c=a,a=Qa);db[a]=d;bb[a]=c.concat(bb[a]||[])},onHighlight:function(a){ab=a},addClass:function(a){cb=a},color:function(a,c,d){if("string"==typeof a)return Ra(a,c,d);if("function"==typeof a)return $a(0,a);$a(a,c)}}}();(function(){if(document.addEventListener)return document.addEventListener("DOMContentLoaded",Rainbow.color,!1);window.attachEvent("onload",Rainbow.color)})();Rainbow.onHighlight=Rainbow.onHighlight;Rainbow.addClass=Rainbow.addClass;Rainbow.extend("c",[{name:"meta.preprocessor",matches:{1:[{matches:{1:"keyword.define",2:"entity.name"},pattern:/(\w+)\s(\w+)\b/g},{name:"keyword.define",pattern:/endif/g},{name:"constant.numeric",pattern:/\d+/g},{matches:{1:"keyword.include",2:"string"},pattern:/(include)\s(.*?)$/g}]},pattern:/\#([\S\s]*?)$/gm},{name:"keyword",pattern:/\b(do|goto|typedef)\b/g},{name:"entity.label",pattern:/\w+:/g},{matches:{1:"storage.type",3:"storage.type",4:"entity.name.function"},pattern:/\b((un)?signed|const)? ?(void|char|short|int|long|float|double)\*? +((\w+)(?= ?\())?/g},
...
j.removeRunDependency=function(a){U--;j.monitorRunDependencies&&j.monitorRunDependencies(U);a?(B(V[a]),delete V[a]):j.a("warning: run dependency removed without ID");0==U&&(W!==h&&(clearInterval(W),W=h),!Da&&X&&Y())};j.preloadedImages={};j.preloadedAudios={};va=8;u=va+176;R.push({c:function(){Ea()}});
...
var Ja=Math.min,Z=function(a,d,c){function e(a){a|=0;var c=0;if((p[172]&a)<<24>>24!=a<<24>>24)return 0;c=0==(p[164]&a)<<24>>24|0;return c|0}function f(a){a|=0;var c=0;if((p[168]&a)<<24>>24!=a<<24>>24)return 0;c=0==(p[160]&a)<<24>>24|0;return c|0}function g(){_flash_load((Ta[152]|0)<<3,8,176);p[178]|=64;p[179]|=64;p[180]|=64;p[181]|=64}function n(){_led_set((Ta[148]|0)<<8|Ta[144]|0)}function ma(){var a=0,a=Qa[37]|0;0!=(a&64|0)&&(Qa[37]=a&-65,Pa(81,0),n())}function Pa(a,c){_midi_send_cmd2(11,0,a|0,
c|0)}function Na(){var a=0;_midi_send_cmd1(12,0,p[128]|0);a=p[128]|0;p[152]=a;p[136]=a;g();Ra();n()}function Ra(){var a=0,c=0,a=p[176+(Ta[120]|0)|0]|0,c=a&255;p[148]=p[148]&-64|a&63;0!=(c&64|0)&&Pa(90,127);0!=(c&16|0)&&Pa(88,127);0!=(c&32|0)&&Pa(89,127);0!=(c&4|0)&&Pa(86,127);0!=(c&2|0)&&Pa(85,127);0!=(c&8|0)&&Pa(87,127);0!=(c&1|0)&&Pa(84,127);0!=(c&128|0)&&Pa(91,127)}function Ua(a){a|=0;6>(a&255)?(p[120]=a,_midi_send_cmd1(12,1,a+4&255),_midi_send_cmd1(12,0,p[152]|0),p[136]=p[152]|0,Ra(),p[144]=(p[144]&
192|1<<(a&255))&255,n()):hb(32,229,64,16)}function $a(a){a|=0;var c=0,d=0,c=a&255;6>(a&255)?(a=1<<c,d=176+(Ta[120]|0)|0,p[d]=((Ta[d]|0)^a)&255,Pa(p[8+c|0]|0,0==(a&(Ta[176+(Ta[120]|0)|0]|0)|0)?0:127),p[148]=((Ta[148]|0)^a)&255,n()):hb(32,166,80,24)}function Wa(a){ab(0);return 0}function Xa(){ab(1)}function bb(a,c){ab(2);return 0}function db(a){ab(3)}"use asm";var p=new a.Int8Array(c);new a.Int16Array(c);var Qa=new a.Int32Array(c),Ta=new a.Uint8Array(c);new a.Uint16Array(c);new a.Uint32Array(c);new a.Float32Array(c);
new a.Float64Array(c);var Za=d.STACKTOP|0,cb=0,ab=d.abort,hb=d.___assert_func,ib=[Wa,Wa],fb=[Xa,Xa],Oa=[bb,bb],Va=[db,db];return{_strlen:function(a){a|=0;for(var c=0,c=a;p[c]|0;)c=c+1|0;return c-a|0},_controller_handle:function(){var a=0,c=a=0,d=c=a=c=a=c=a=a=0,a=_fsw_poll()|0;p[168]=a&255;p[172]=(a&65535)>>>8&255;0!=(e(1)|0)<<24>>24&&$a(0);0!=(e(2)|0)<<24>>24&&$a(1);0!=(e(4)|0)<<24>>24&&$a(2);0!=(e(8)|0)<<24>>24&&$a(3);0!=(e(16)|0)<<24>>24&&$a(4);0!=(e(32)|0)<<24>>24&&$a(5);0!=(f(1)|0)<<24>>24&&
(Ua(0),ma());0!=(f(2)|0)<<24>>24&&(Ua(1),ma());0!=(f(4)|0)<<24>>24&&(Ua(2),ma());0!=(f(8)|0)<<24>>24&&(Ua(3),ma());0!=(f(16)|0)<<24>>24&&(Ua(4),ma());0!=(f(32)|0)<<24>>24&&(Ua(5),ma());0!=(e(64)|0)<<24>>24&&(p[148]^=64,Pa(81,0!=(Qa[37]&64|0)?127:0),n());0==(f(64)|0)<<24>>24?59>=(Ta[104]|0)||0==(Qa[42]&64|0)||(_flash_store((Ta[152]|0)<<3,8,176),p[112]=80,p[104]=0):(a=p[96]&127^127,p[96]=a,Pa(80,a),p[104]=1);Qa[36]=Qa[36]&-65|Qa[42]&64;0!=(e(-128)|0)<<24>>24&&(a=p[128]|0,0!=a<<24>>24&&(p[128]=a-1&255),
Na());0!=(f(-128)|0)<<24>>24&&(a=p[128]|0,127!=a<<24>>24&&(p[128]=a+1&255),Na());a=Qa[43]|0;c=Qa[37]|0;a=c&-129|a&128;Qa[37]=a;a=Qa[42]|0;c=Qa[36]|0;a=c&-129|a&128;Qa[36]=a;n();c=168;a=Qa[(c|0)>>2]|0;c=Qa[(c+4|0)>>2]|0;d=160;Qa[(d|0)>>2]=a;Qa[(d+4|0)>>2]=c},_controller_init:function(){p[148]=0;p[144]=0;p[104]=0;p[112]=0;p[120]=0;p[152]=0;p[128]=0;p[136]=0;p[176]=0;p[177]=16;p[178]=0;p[179]=16;p[180]=0;p[181]=16;p[182]=0;p[183]=0;g();Ua(0)},_memset:function(a,c,d){a|=0;c|=0;d|=0;var e=0,f=0,g=0,e=
a+d|0;if(20<=(d|0)){c&=255;d=a&3;f=c|c<<8|c<<16|c<<24;g=e&-4;if(d)for(d=a+4-d|0;(a|0)<(d|0);)p[a]=c,a=a+1|0;for(;(a|0)<(g|0);)Qa[a>>2]=f,a=a+4|0}for(;(a|0)<(e|0);)p[a]=c,a=a+1|0},_memcpy:function(a,c,d){a|=0;c|=0;d|=0;var e=0,e=a|0;if((a&3)==(c&3)){for(;a&3;){if(0==(d|0))return e|0;p[a]=p[c]|0;a=a+1|0;c=c+1|0;d=d-1|0}for(;4<=(d|0);)Qa[a>>2]=Qa[c>>2],a=a+4|0,c=c+4|0,d=d-4|0}for(;0<(d|0);)p[a]=p[c]|0,a=a+1|0,c=c+1|0,d=d-1|0;return e|0},_controller_10msec_timer:function(){var a=0,c=0;0!=(Qa[42]&64|0)&&
(a=p[104]|0,0!=a<<24>>24&&(p[104]=a+1&255));a=p[112]|0;0!=a<<24>>24&&(c=a-1&255,p[112]=c,0==c<<24>>24?p[148]=p[148]&-64|p[176+(Ta[120]|0)|0]&63:(a=p[148]|0,p[148]=6<(c&15)>>>0?a|63:a&-64),n())},runPostSets:function(){},stackAlloc:function(a){var c=0,c=Za;Za=Za+(a|0)|0;Za=Za+7>>3<<3;return c|0},stackSave:function(){return Za|0},stackRestore:function(a){Za=a|0},setThrew:function(a,c){0==(cb|0)&&(cb=a|0)},setTempRet0:function(a){},setTempRet1:function(a){},setTempRet2:function(a){},setTempRet3:function(a){},
setTempRet4:function(a){},setTempRet5:function(a){},setTempRet6:function(a){},setTempRet7:function(a){},setTempRet8:function(a){},setTempRet9:function(a){},dynCall_ii:function(a,c){return ib[(a|0)&1](c|0)|0},dynCall_v:function(a){fb[(a|0)&1]()},dynCall_iii:function(a,c,d){return Oa[(a|0)&1](c|0,d|0)|0},dynCall_vi:function(a,c){Va[(a|0)&1](c|0)}}}({Math:Math,Int8Array:Int8Array,Int16Array:Int16Array,Int32Array:Int32Array,Uint8Array:Uint8Array,Uint16Array:Uint16Array,Uint32Array:Uint32Array,Float32Array:Float32Array,
Float64Array:Float64Array},{abort:x,assert:B,asmPrintInt:function(a,d){j.print("int "+a+","+d)},asmPrintFloat:function(a,d){j.print("float "+a+","+d)},min:Ja,invoke_ii:function(a,d){try{return j.dynCall_ii(a,d)}catch(c){if("number"!==typeof c&&"longjmp"!==c)throw c;Z.setThrew(1,0)}},invoke_v:function(a){try{j.dynCall_v(a)}catch(d){if("number"!==typeof d&&"longjmp"!==d)throw d;Z.setThrew(1,0)}},invoke_iii:function(a,d,c){try{return j.dynCall_iii(a,d,c)}catch(e){if("number"!==typeof e&&"longjmp"!==
e)throw e;Z.setThrew(1,0)}},invoke_vi:function(a,d){try{j.dynCall_vi(a,d)}catch(c){if("number"!==typeof c&&"longjmp"!==c)throw c;Z.setThrew(1,0)}},_malloc:sa,___assert_func:function(a,d,c,e){throw"Assertion failed: "+(e?C(e):"unknown condition")+", at: "+[a?C(a):"unknown filename",d,c?C(c):"unknown function"]+" at "+Error().stack;},_free:function(){},STACKTOP:s,STACK_MAX:N,tempDoublePtr:Fa,ABORT:z,NaN:NaN,Infinity:Infinity},O),Ia=j._strlen=Z._strlen;j._controller_handle=Z._controller_handle;
j._controller_init=Z._controller_init;var Ha=j._memset=Z._memset,Ga=j._memcpy=Z._memcpy;j._controller_10msec_timer=Z._controller_10msec_timer;var Ea=j.runPostSets=Z.runPostSets;j.dynCall_ii=Z.dynCall_ii;j.dynCall_v=Z.dynCall_v;j.dynCall_iii=Z.dynCall_iii;j.dynCall_vi=Z.dynCall_vi;t=function(a){return Z.stackAlloc(a)};r=function(){return Z.stackSave()};fa=function(a){Z.stackRestore(a)};function Ka(a){this.name="ExitStatus";this.message="Program terminated with exit("+a+")";this.status=a}
Ka.prototype=Error();var La,$=h;

...
/****** Processor Specific Definitions ******************************/
    ...
    */
    #define RM_RESET_VECTOR             0x000A00
    #define RM_HIGH_INTERRUPT_VECTOR    0x000A08
    #define RM_LOW_INTERRUPT_VECTOR     0x000A18
#else
...
/** Conditional Codes ********************************************************/
//Conditional assembly definitions	Added 4/29/05 691213 x003 AR
//Only define one of the three below
#define	LAB_TEST
//#define	PRE_PRODUCTION
//#define	PRODUCTION
//#define		PRODUCTION_NO_ENCRYPT

#ifdef		LAB_TEST
	//#define	CHECKSUM_CHECK_EN
